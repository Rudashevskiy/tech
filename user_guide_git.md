...
### 1.3.3. Обработка конфликтов при слиянии
...
### 1.4.1. Несохраненные изменения при переключении веток
...
### 1.4.2. Отсутствие доступа к удаленному репозиторию
...
### 1.5.1. Использование `git push -f`
...
### 1.5.2. Переписывание истории с помощью `git rebase` на публичных ветках
...
### 1.5.3. Удаление веток без проверки
...
### 1.5.4. Использование `git reset --hard`
